...
knitr::include_graphics("./images/svmClassification3.JPG")
```
...
```{r, out.width = "800px", echo=FALSE}
knitr::include_graphics("./images/svmClassification4.JPG")
knitr::include_graphics("./images/svmClassification5.JPG")
```
...
```{r, out.width = "800px", echo=FALSE}
knitr::include_graphics("./images/svmClassification6.JPG")
```

```{r kernalSVM, warning=FALSE, message=FALSE}

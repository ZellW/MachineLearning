...
For this experiment, default parameter values were used. Perhaps in the future this experiment will be updated to optimized the model performance.
...
Number of Rounds: __`r bst$current_iter() `__.

Multilogloss of Best Model: __`r bst$record_evals$test$multi_logloss$eval %>% unlist() %>% tail(1)`__.

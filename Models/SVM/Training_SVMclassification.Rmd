...
knitr::include_graphics("../images/svmClassification1.JPG")
knitr::include_graphics("../images/svmClassification2.JPG")
```

```{r svmClassification, warning=FALSE, message=FALSE}

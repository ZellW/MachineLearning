...
```{r}
ws <- workspace(id = "7922039ab9194623ab8380b02d3b3e73", 
                auth = "Pwesjg/iUhDUzCEmCWUdioGTo3Mv+YV7k04HNAW/w3yAIaG/EoThGCUjlICFPEoJ3PTuRsdNCI6temcUekVUwA==")
```
...
```{r}
api <- updateWebService(ws, fun = function(x, y) x - y, inputSchema = list(x = "numeric",
                                                                           y = "numeric"),
                        outputSchema = list(ans = "numeric"),

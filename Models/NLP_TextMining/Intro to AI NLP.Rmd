...
__Intent__:  Simply put, intents are the intentions of the end-user, these intentions or intents are conveyed by the user to your bot. You can mainly put your intents in 2 categories
...
__Training for Intents and Entities__
...
knitr::include_graphics("../images/diagram1.jpg") 
```
